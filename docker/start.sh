...
docker run -it -d --rm \
    ...
    --name ${USER}_mmpr \
    --net host \
    -v $PROJECT_ROOT_DIR:/home/docker_mmpr/multimodal-place-recognition:rw \
    -v $DATASETS_DIR:/home/docker_mmpr/Datasets:rw \
    multimodal-place-recognition:devel

docker exec --user root \
    ${USER}_mmpr bash -c "/etc/init.d/ssh start"
