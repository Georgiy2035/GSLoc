...
class PointCloudStore:
    ...
    Attributes:
        ...
        default_num_properties: Expected number of properties per point in `.bin`
            files; typically 3 (x,y,z) or 4 (x,y,z,intensity). The loader will
            slice to first 3 dims.
    """
